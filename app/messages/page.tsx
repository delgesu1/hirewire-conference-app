    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="fixed bottom-24 right-4">
        <Button
          ...
          className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 shadow-lg flex items-center justify-center flex-col gap-1"
        >
